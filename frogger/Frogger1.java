...
public class Frogger1 extends Applet implements Runnable, KeyListener 
{ 
 ...
 {
  g.drawImage(froggerBackground, 0, 0, this);
 
  g.drawImage(currentFrogImage, FrogX, FrogY, this);
  g.setColor(Color.red);
  
  g.drawImage(redCar, redCarX, redCarY, this);
  
  g.drawImage(blueCar, blueCarX, blueCarY, this);
